 ...
 */
public class ICTopFiveStudyDataLoad implements IDataLoad {
    private static Logger log = Logger.getLogger(ICTopFiveStudyDataLoad.class);

    private IronCondorDao ironCondorDao;
    private ICStudyResultDao studyResultDao;
    private ICTopFiveStudyHelper dlHelper;
    ...
    public ICTopFiveStudyHelper getDlHelper() {
        return dlHelper;
    }
    public void setDlHelper(ICTopFiveStudyHelper dlHelper) {
