 ...
 */
public class ICTopTenStudyDataLoad implements IDataLoad {
    private static Logger log = Logger.getLogger(ICTopTenStudyDataLoad.class);

    private IronCondorDao ironCondorDao;
    private ICStudyResultDao studyResultDao;
    private ICTopTenStudyHelper dlHelper;
    ...
    public ICTopTenStudyHelper getDlHelper() {
        return dlHelper;
    }
    public void setDlHelper(ICTopTenStudyHelper dlHelper) {
