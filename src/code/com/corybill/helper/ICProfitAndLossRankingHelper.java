 ...
 */
public class ICProfitAndLossRankingHelper {
    private Map<String,List<IronCondor>> map;
     ...
     * @param condor
     */
    public void addToOrderedPaLList(IronCondor condor){
        for(Integer maxLoss : TradingConstants.maxLosses){
    ...
    public void setRanks(){
        ...
        while (it.hasNext()) {
            ...
            List<IronCondor> list = (List<IronCondor>)pairs.getValue();
            for(int i=0; i<list.size(); i++){
