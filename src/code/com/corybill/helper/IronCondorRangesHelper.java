 ...
 */
public class IronCondorRangesHelper {
     ...
     * @return
     */
    public Map<Integer,List<VanillaOption>> createCondorsOptions(List<Quote> quotes,Integer rangeDays){
        ...
        Quote mondayQuote = quotes.get(quotes.size()-1);
        TradingRange tradingRange = mondayQuote.getTradingRanges().get(rangeDays);

        double upperLimit = tradingRange.getHigh() - mondayQuote.getOhlc().getOpen();
        double lowerLimit = mondayQuote.getOhlc().getOpen() - tradingRange.getLow();
        double strikeInterval = getStrikeInterval(mondayOpen);
        MutableDouble shortPutStrike = new MutableDouble( getLowerBound(mondayOpen,lowerLimit,strikeInterval)  );
        MutableDouble shortCallStrike = new MutableDouble( getUpperBound(mondayOpen,upperLimit,strikeInterval) );
        ...
        Calendar expirationCal = calendarHelper.getCalendar(quotes.get(quotes.size() - 1).getDate());
    ...
    public IronCondorRanges buildIronCondor(Map<Integer,List<VanillaOption>> map,List<Quote> weeksQuotes, int rangeDays){
        ...
        IronCondorRanges condor = new IronCondorRanges();
    ...
    private int getOpen(List<VanillaOption> list,IronCondorRanges condor){
        try{
    ...
    private void getHigh(List<VanillaOption> list,IronCondorRanges condor,int executable,String currentDate){
    ...
    private void getLow(List<VanillaOption> list,IronCondorRanges condor,int executable,String currentDate){
    ...
    private void getClose(List<VanillaOption> list,IronCondorRanges condor, int executable,Quote fridayQuote){
